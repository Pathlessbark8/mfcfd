    ...
    subroutine eval_q_inner_loop()
        ...
        do i = 1, local_points
            ...
            do k = 1, point%nbhs(i)
                ...
                &(1.0d0/12.0d0) * (delx*delx * point%ddq(1,1,nbh) + 2*delx*dely * point%ddq(2,1,nbh) + &
                &dely*dely * point%ddq(3,1,nbh))
                ...
                &(1.0d0/12.0d0) * (delx*delx * point%ddq(1,2,nbh) + 2*delx*dely * point%ddq(2,2,nbh) + &
                &dely*dely * point%ddq(3,2,nbh))
                ...
                &(1.0d0/12.0d0) * (delx*delx * point%ddq(1,3,nbh) + 2*delx*dely * point%ddq(2,3,nbh) + &
                &dely*dely * point%ddq(3,3,nbh))
                ...
                &(1.0d0/12.0d0) * (delx*delx * point%ddq(1,4,nbh) + 2*delx*dely * point%ddq(2,4,nbh) + &
                &dely*dely * point%ddq(3,4,nbh))

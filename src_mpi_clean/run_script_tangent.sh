...
rm -rf phi_files_tangent
mkdir phi_files_tangent
clear
echo '*********Running the TAPENADE script*************'

tapenade -forward -fixinterface -O phi_files_tangent/ -head "q_lskum" -vars "point%phi1 point%phi2" -outvars "total_enstrophy" \
...
rename .f90 .F90 phi_files_tangent/*.f90

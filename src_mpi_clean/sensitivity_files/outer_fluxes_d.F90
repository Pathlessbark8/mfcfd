...
&                          rho, rhod, pr, prd)
      CALL FLUX_QUAD_GXIII_D(g_i, g_id, nx, nxd, ny, nyd, u1, u1d, u2, &
&                      u2d, rho, rhod, pr, prd)
      CALL QTILDE_TO_PRIMITIVE_D(qtilde_k, qtilde_kd, u1, u1d, u2, u2d, &
&                          rho, rhod, pr, prd)
      CALL FLUX_QUAD_GXIII_D(g_k, g_kd, nx, nxd, ny, nyd, u1, u1d, u2, &
&                      u2d, rho, rhod, pr, prd)
...
&       dely*point%dq(2, :, k))
      CALL QTILDE_TO_PRIMITIVE_D(qtilde_i, qtilde_id, u1, u1d, u2, u2d, &
&                          rho, rhod, pr, prd)
      CALL FLUX_QUAD_GXIV_D(g_i, g_id, nx, nxd, ny, nyd, u1, u1d, u2, &
&                     u2d, rho, rhod, pr, prd)
      CALL QTILDE_TO_PRIMITIVE_D(qtilde_k, qtilde_kd, u1, u1d, u2, u2d, &
&                          rho, rhod, pr, prd)
      CALL FLUX_QUAD_GXIV_D(g_k, g_kd, nx, nxd, ny, nyd, u1, u1d, u2, &
&                     u2d, rho, rhod, pr, prd)
      sum_delx_delfd = sum_delx_delfd + (g_kd-g_id)*dels_weights + (g_k-&
&       g_i)*dels_weightsd
      sum_delx_delf = sum_delx_delf + (g_k-g_i)*dels_weights

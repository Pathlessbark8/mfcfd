...
!   with respect to varying inputs: g nx ny u1 u2 pr rho
  SUBROUTINE FLUX_QUAD_GXI_D0(g, gd, nx, nxd, ny, nyd, u1, u1d, u2, u2d&
&   , rho, rhod, pr, prd)
    IMPLICIT NONE
...
!   variations   of useful results: g
!   with respect to varying inputs: g nx ny u1 u2 pr rho
  SUBROUTINE FLUX_QUAD_GXII_D0(g, gd, nx, nxd, ny, nyd, u1, u1d, u2, u2d&
&   , rho, rhod, pr, prd)
    IMPLICIT NONE
    DOUBLE PRECISION :: g(4), u1, u2, rho, pr
    DOUBLE PRECISION :: gd(4), u1d, u2d, rhod, prd
...
!   variations   of useful results: g
!   with respect to varying inputs: g nx ny u1 u2 pr rho
  SUBROUTINE FLUX_QUAD_GXIII_D0(g, gd, nx, nxd, ny, nyd, u1, u1d, u2, &
&   u2d, rho, rhod, pr, prd)
    IMPLICIT NONE
    DOUBLE PRECISION :: g(4), u1, u2, rho, pr
    DOUBLE PRECISION :: gd(4), u1d, u2d, rhod, prd
...
!   variations   of useful results: g
!   with respect to varying inputs: g nx ny u1 u2 pr rho
  SUBROUTINE FLUX_QUAD_GXIV_D0(g, gd, nx, nxd, ny, nyd, u1, u1d, u2, u2d&
&   , rho, rhod, pr, prd)
    IMPLICIT NONE
    DOUBLE PRECISION :: g(4), u1, u2, rho, pr
    DOUBLE PRECISION :: gd(4), u1d, u2d, rhod, prd

module generate_connectivity_mod
        ...
        subroutine generate_connectivity_x()
		...
		real*8 :: nx, ny
                ...
                do k = 1, interior_points
                                        ...
                                        nx = point%nx(i)
                                        ny = point%ny(i)
                                        call get_interior_neighbours_X(i, nx, ny)
                enddo
                ...
                do k = 1, wall_points
                                        ...
                                        nx = point%nx(i)
                                        ny = point%ny(i)
                                        call get_wall_boundary_neighbours_x(i, nx, ny)
                enddo
                ...
                do k = 1, outer_points
                                        ...
                                        nx = point%nx(i)
                                        ny = point%ny(i)
                                        call get_outer_boundary_neighbours_x(i, nx, ny)
                enddo

        end subroutine 

        subroutine get_interior_neighbours_x(i, nx, ny)
        ...
        subroutine get_wall_boundary_neighbours_x(i, nx, ny)
        ...
        subroutine get_outer_boundary_neighbours_x(i, nx, ny)

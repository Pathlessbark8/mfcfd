...
C   Apart from TRVERS this file contains five auxiliary routines     * 
...
C   information is sent to standard output. When INFO > 0 TRVERS     *
...
C     .. Parameters ..
      ...
      PARAMETER (CHEKUP=902,REPSUP=902)
C     ..
C     .. Scalar Arguments ..
      INTEGER SNAPS,STEPS
C     ..

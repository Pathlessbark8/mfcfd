...
CONTAINS
  ...
  subroutine allocate_soln_b()
    ...
    ALLOCATE(pointb%divergence_sqr(max_points))
    ALLOCATE(pointb%du1_dx(max_points))
    ALLOCATE(pointb%du2_dy(max_points))
  end subroutine
  ...
  subroutine deallocate_soln_b()
    ...
    DEALLOCATE(pointb%divergence_sqr)
    DEALLOCATE(pointb%du1_dx)
    DEALLOCATE(pointb%du2_dy)
  end subroutine

...
&       sum_dely_delfb
      ...
      CALL FLUX_QUAD_GXII_B(g_k, g_kb, nx, nxb, ny, nyb, u1, u1b, u2, &
&                     u2b, rho, rhob, pr, prb)
      CALL POPREAL8(u1)
      CALL POPREAL8(u2)
      CALL POPREAL8(rho)
...
&                          rho, rhob, pr, prb)
      ...
      CALL FLUX_QUAD_GXII_B(g_i, g_ib, nx, nxb, ny, nyb, u1, u1b, u2, &
&                     u2b, rho, rhob, pr, prb)
      CALL POPREAL8(u1)
      CALL POPREAL8(u2)
      CALL POPREAL8(rho)
...
&       sum_dely_delfb
      dels_weightsb = dels*sum_delx_sqrb + SUM((g_k-g_i)*sum_delx_delfb)
      CALL POPREAL8ARRAY(g_k, 4)
      CALL FLUX_QUAD_GXI_B(g_k, g_kb, nx, nxb, ny, nyb, u1, u1b, u2, u2b&
&                    , rho, rhob, pr, prb)
      CALL POPREAL8(u1)
      CALL POPREAL8(u2)
      CALL POPREAL8(rho)
...
&                          rho, rhob, pr, prb)
      CALL POPREAL8ARRAY(g_i, 4)
      CALL FLUX_QUAD_GXI_B(g_i, g_ib, nx, nxb, ny, nyb, u1, u1b, u2, u2b&
&                    , rho, rhob, pr, prb)
      CALL POPREAL8(u1)
      CALL POPREAL8(u2)
      CALL POPREAL8(rho)

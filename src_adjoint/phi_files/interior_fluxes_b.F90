...
&       sum_dely_delfb
      CALL FLUX_GXP_B(g_k, g_kb, nx, ny, u1, u1b, u2, u2b, rho, rhob, pr&
&               , prb)
      CALL POPREAL8(u1)
      CALL POPREAL8(u2)
      CALL POPREAL8(rho)
...
&                          rho, rhob, pr, prb)
      CALL FLUX_GXP_B(g_i, g_ib, nx, ny, u1, u1b, u2, u2b, rho, rhob, pr&
&               , prb)
      CALL POPREAL8(u1)
      CALL POPREAL8(u2)
      CALL POPREAL8(rho)
...
&       sum_dely_delfb
      g_ib = g_ib - dels_weights*sum_delx_delfb - deln_weights*&
&       sum_dely_delfb
      CALL FLUX_GXN_B(g_k, g_kb, nx, ny, u1, u1b, u2, u2b, rho, rhob, pr&
&               , prb)
      CALL POPREAL8(u1)
      CALL POPREAL8(u2)
      CALL POPREAL8(rho)
      ...
      CALL QTILDE_TO_PRIMITIVE_B(qtilde_k, qtilde_kb, u1, u1b, u2, u2b, &
&                          rho, rhob, pr, prb)
      CALL FLUX_GXN_B(g_i, g_ib, nx, ny, u1, u1b, u2, u2b, rho, rhob, pr&
&               , prb)
      CALL POPREAL8(u1)
      CALL POPREAL8(u2)
      CALL POPREAL8(rho)
...
&       sum_dely_delfb
      g_ib = g_ib - dels_weights*sum_delx_delfb - deln_weights*&
&       sum_dely_delfb
      CALL FLUX_GYP_B(g_k, g_kb, nx, ny, u1, u1b, u2, u2b, rho, rhob, pr&
&               , prb)
      CALL POPREAL8(u1)
      CALL POPREAL8(u2)
      CALL POPREAL8(rho)
      ...
      CALL QTILDE_TO_PRIMITIVE_B(qtilde_k, qtilde_kb, u1, u1b, u2, u2b, &
&                          rho, rhob, pr, prb)
      CALL FLUX_GYP_B(g_i, g_ib, nx, ny, u1, u1b, u2, u2b, rho, rhob, pr&
&               , prb)
      CALL POPREAL8(u1)
      CALL POPREAL8(u2)
      CALL POPREAL8(rho)

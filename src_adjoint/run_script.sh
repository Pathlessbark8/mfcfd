...
# tapenade -tangent -fixinterface -O phi_files/ -head "q_lskum" -vars "point%phi1 point%phi2" -outvars "cost_func" *.F90

tapenade -reverse -fixinterface -O phi_files/ -head "q_lskum" -vars "point%phi1 point%phi2" -outvars "cost_func" \
...
# compute_enstrophy.F90
# tapenade -tangent -fixinterface -O phi_files/ -head "meshfree_solver" -vars "phi_i" -outvars "aoa" *.F90
# rename -v 's/\.f90$/.F90/' phi_files/*.f90
rename .f90 .F90 phi_files/*.f90

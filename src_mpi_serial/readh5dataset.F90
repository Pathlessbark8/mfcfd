...
MODULE ReadH5Dataset
    ...
    PUBLIC :: H5ReadDataset, H5ReadAttribute, H5Read_initfile, H5Read_closefile
    ...
    MODULE PROCEDURE  &
        ...
        MODULE PROCEDURE  &
            ...
            END SUBROUTINE H5Read_initfile
            ...
            END SUBROUTINE H5Read_closefile
            ...
            SUBROUTINE H5Read_close
                ...
                IF ( ALLOCATED(OpenLevels_id) ) THEN
                    ...
                    DO n = NLevels,1,-1
                        ...
                        else if ( ltype.eq.H5G_DATASET_F ) then
